            ...
            <div className="flex flex-wrap gap-3 md:gap-2">
              {filterOptions.topics.map(topic => (
                <button
                  ...
                  className={`px-4 py-2 md:px-3 md:py-1 rounded-full text-sm md:text-xs font-medium transition-colors touch-manipulation ${
                  ...
                  <React.Fragment key={result.id}>
                    ...
                    >
                      <div className="flex gap-4 md:gap-3">
                        {/* Thumbnail */}
                        {result.imageUrl && (
                          <div className="flex-shrink-0 w-24 h-24 md:w-20 md:h-20 rounded-lg overflow-hidden bg-[#F1F3F4]">
                            <img
                              src={result.imageUrl}
                              alt={result.headline}
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          {result.sources && result.sources.length > 0 && (
                            <div className="text-sm md:text-xs text-[#5F6368] mb-1">
                              {result.sources[0].name}
                            </div>
                          )}
                          
                          {/* Headline */}
                          <h3 className="font-medium text-[#202124] mb-1 line-clamp-3 md:line-clamp-2 text-base md:text-sm group-hover:text-[#1A73E8] group-active:text-[#1A73E8] transition-colors">
                            {result.headline}
                          </h3>
                          
                          {/* Meta Info */}
                          <div className="flex items-center gap-2 text-sm md:text-xs text-[#9AA0A6] mt-2 md:mt-1">
